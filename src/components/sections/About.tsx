...
import { MapPin, GraduationCap, Github, Linkedin, BookOpen } from "lucide-react";
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid md:grid-cols-[1fr_1fr] gap-16 lg:gap-28 items-start">
                    <div className="space-y-5">
                        <motion.p {...stagger(0)} className="text-lg leading-relaxed" style={{ color: theme.textSub }}>
                        ...
                        <motion.p {...stagger(1)} className="leading-relaxed" style={{ color: theme.textMuted }}>
                        ...
                        <motion.p {...stagger(2)} className="leading-relaxed" style={{ color: theme.textMuted }}>
                        ...
                        <motion.div {...stagger(3)} className="flex flex-wrap gap-5 pt-4">
                            {[
                                ...
                                <div key={text} className="flex items-center gap-2 text-sm" style={{ color: theme.textFaint }}>
                    ...
                    <div className="space-y-8">
                        <motion.div {...stagger(0)}>
                            <p
                                ...
                                style={{ fontFamily: "var(--font-mono)", fontSize: "0.65rem", letterSpacing: "0.18em", color: theme.textFaint }}
                            >
                                Research Interests
                            </p>
                        ...
                        <motion.div {...stagger(1)} className="grid grid-cols-2 gap-3">
                            {stats.map(({ value, label, color }) => (
                                ...
                                >
                                    ...
                                    <div className="text-sm" style={{ color: theme.textFaint }}>{label}</div>
                                </div>
                            ))}
                        </motion.div>
                    </div>
