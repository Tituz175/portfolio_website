...
import { ArrowUpRight, Download, Mail, Github, Linkedin, BookOpen } from "lucide-react";
...
function HeroBg() {
    ...
    return (
        <div className="absolute inset-0 overflow-hidden pointer-events-none select-none">
            ...
            />
            <svg className="absolute inset-0 w-full h-full" style={{ opacity: theme.gridOpacity }}>
                <defs>
        ...
        >
          ...
          Incoming PhD Student · University of Delaware · Fall 2025
                ...
                <motion.div {...heroAnim(0.66)} className="flex items-center justify-center gap-4">
                    {[
                        ...
                        <a
                            ...
                            style={{ borderColor: theme.border, color: theme.textFaint, backgroundColor: "transparent" }}
                            onMouseEnter={(e) => {
                                e.currentTarget.style.borderColor = theme.borderHover;
                                e.currentTarget.style.color = theme.text;
            ...
            >
                ...
                <div
                    className="w-px h-10"
                    style={{ background: `linear-gradient(to bottom, ${theme.textVeryFaint}, transparent)` }}
                />
            </motion.div>
        </section>
    );
